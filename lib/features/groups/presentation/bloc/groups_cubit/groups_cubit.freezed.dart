...
mixin _$GroupsState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is GroupsState);
  }
...
/// @nodoc
class $GroupsStateCopyWith<$Res> {
  $GroupsStateCopyWith(GroupsState _, $Res Function(GroupsState) __);
}
...
class _Initial implements GroupsState {
  const _Initial();
...
class _Loading implements GroupsState {
  const _Loading();
...
class _Loaded implements GroupsState {
  const _Loaded({required final List<GroupModel> groups}) : _groups = groups;
...
class _Empty implements GroupsState {
  const _Empty();
...
class _Error implements GroupsState {
