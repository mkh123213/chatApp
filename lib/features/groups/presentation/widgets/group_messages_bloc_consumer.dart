...
import 'package:chat_material3/features/groups/presentation/widgets/seen_by_bottom_sheet.dart';
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text(context.translate(LangKeys.reply)),
              onTap: () {
            ...
            if (isMe)
              ListTile(
                ...
                title: Text(context.translate(LangKeys.seenBy)),
                onTap: () {
                  Navigator.pop(sheetContext);
                  showSeenByBottomSheet(context, message.readBy);
                },
              ),
          ],
        ),
