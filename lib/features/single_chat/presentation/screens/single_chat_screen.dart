...
import 'package:chat_material3/core/common/widgets/chat/reply_preview_bar.dart';
...
class _SingleChatScreenState extends State<SingleChatScreen> {
  ...
  String _getSenderName(MessageModel msg) {
    ...
    return _getFriendDisplayName(widget.chat);
  }
      ...
      providers: [
        BlocProvider(
          create: (_) => sl<MessagesCubit>()
            ..setDisappearingDuration(chat.disappearingDuration)
                            ...
                            BlocBuilder<BlockCubit, BlockState>(
                              builder: (context, blockState) {
                                ...
                                return ChatMessageInput(
                                  replyWidget: _replyingTo != null
                                      ? ReplyPreviewBar(
                                          senderName:
                                              _getSenderName(_replyingTo!),
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(context.translate(
                              LangKeys.disappearingMessagesSetting)),
                        ],
                      ),
                    ),
                    if (blockedByMe)
  ...
  void _handleMenuAction(
    ...
    if (action == 'disappearing') {
      showDisappearingMessagesDialog(
        context: context,
        currentDuration: chat.disappearingDuration,
        onSelect: (duration) {
          sl<ChatsRepo>().setDisappearingMessages(
                chatId: chat.id,
