...
mixin _$StatusState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StatusState);
  }
...
/// @nodoc
class $StatusStateCopyWith<$Res> {
  $StatusStateCopyWith(StatusState _, $Res Function(StatusState) __);
}
...
extension StatusStatePatterns on StatusState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<StatusModel> recent, List<StatusModel> viewed)?
        loaded,
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.recent, _that.viewed);
      case _Empty() when empty != null:
        return empty();
      case _Error() when error != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<StatusModel> recent, List<StatusModel> viewed)
        loaded,
...
class _Initial implements StatusState {
  const _Initial();
...
class _Loading implements StatusState {
  const _Loading();
...
class _Loaded implements StatusState {
  const _Loaded(
      {required final List<StatusModel> recent,
      required final List<StatusModel> viewed})
      : _recent = recent,
        _viewed = viewed;

  final List<StatusModel> _recent;
  List<StatusModel> get recent {
    if (_recent is EqualUnmodifiableListView) return _recent;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_recent);
  }

  final List<StatusModel> _viewed;
  List<StatusModel> get viewed {
  ...
  @override
  String toString() {
    return 'StatusState.loaded(recent: $recent, viewed: $viewed)';
  }
}
...
abstract mixin class _$LoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({List<StatusModel> recent, List<StatusModel> viewed});
}
...
class _Empty implements StatusState {
  const _Empty();
...
class _Error implements StatusState {
