...
// CHANGE: Pass your Agora App ID when constructing this service.
import 'dart:async';

import 'package:agora_rtc_engine/agora_rtc_engine.dart';
import 'package:core_config/src/service/call_service/call_provider_service.dart';

class AgoraCallProviderService implements CallProviderService {
  AgoraCallProviderService({required this.appId}); // CHANGE: pass your Agora App ID
