...
class ColorsLight {
  ...
  // Custom UI colors
  static const Color inputFill = Color(0xFFFDF7FF);
  static const Color inputBorder = Color(0xFFCBC4D2);
  static const Color hint = Color(0x80494551);
  static const Color saveButtonGradientEnd = Color(0xFF422E75);
}
